...
public class CardController {
    ...
    public ResponseEntity<ResponseDto> createCard(@Valid @RequestParam
        ...
        return new ResponseEntity<>(new ResponseDto(CardConstants.STATUS_201, CardConstants.MESSAGE_201), HttpStatus.OK);
    }
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardDto> fetchCardDetails(@RequestHeader("bank-correlation-id") String correlationID, @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
