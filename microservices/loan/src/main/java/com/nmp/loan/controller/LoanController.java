package com.nmp.loan.controller;
...
import com.nmp.loan.dto.ResponseDto;
...
public class LoanController {
    ...
    public ResponseEntity<ResponseDto> createLoan(@RequestParam
        ...
        return new ResponseEntity<>(new ResponseDto(LoanConstants.STATUS_201, LoanConstants.MESSAGE_201), HttpStatus.OK);
...
/*        return ResponseEntity
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoanDto> fetchLoanDetails(@RequestHeader("bank-correlation-id") String correlationID, @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
...
/*          //another way to return ResponseEntity object
            return ResponseEntity
